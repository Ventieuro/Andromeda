...
const LUNA: ThemeTokens = {
  ...
  fabText: '#ffffff',
  txIncomeBg: '#f0fdf4',
  txIncomeBorder: '#bbf7d0',
  txIncomeText: '#166534',
  txIncomeLabel: '#16a34a',
  txExpenseBg: '#fef2f2',
  txExpenseBorder: '#fecaca',
  txExpenseText: '#dc2626',
  txExpenseLabel: '#b91c1c',
  txBalancePosBg: '#ede9fe',
  txBalancePosBorder: '#ddd6fe',
  txBalancePosText: '#6366f1',
  txBalancePosLabel: '#7c3aed',
  txBalanceNegBg: '#fff7ed',
  txBalanceNegBorder: '#fed7aa',
  txBalanceNegText: '#ea580c',
  txBalanceNegLabel: '#c2410c',
}
