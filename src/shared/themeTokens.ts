...
const SUPERNOVA: ThemeTokens = {
  ...
  accent: '#c91010',
  accentHover: '#a80d0d',
  accentLight: 'rgba(201,16,16,0.16)',
  navBg: '#050505',
  navText: '#f5f5f5',
  btnBg: '#161616',
  btnText: '#f5f5f5',
  ...
  fabBg: '#c91010',
  fabText: '#0a0a0a',
  txIncomeBg: 'rgba(54,150,86,0.14)',
  txIncomeBorder: 'rgba(54,150,86,0.38)',
  txIncomeText: '#71d18b',
  txIncomeLabel: '#53b773',
  txExpenseBg: 'rgba(255,43,43,0.14)',
  txExpenseBorder: 'rgba(255,43,43,0.38)',
  txExpenseText: '#ff6666',
  txExpenseLabel: '#ff4a4a',
  txBalancePosBg: 'rgba(255,179,71,0.12)',
  txBalancePosBorder: 'rgba(255,179,71,0.32)',
  txBalancePosText: '#ffc66b',
  txBalancePosLabel: '#ffb347',
  txBalanceNegBg: 'rgba(255,43,43,0.14)',
  txBalanceNegBorder: 'rgba(255,43,43,0.38)',
  txBalanceNegText: '#ff6666',
  txBalanceNegLabel: '#ff4a4a',
}
