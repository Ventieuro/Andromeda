...
const PLANET_CATALOG: PlanetEntry[] = [
  ...
  { alias: 'Ember Twin',    source: 'Outer Wilds',            rarity: 'common',    lore: t("Una luna desertica di sabbia rossa che scambia materia con il suo gemello. La vedo svuotarsi lentamente.", "A desert moon of red sand slowly trading matter with its twin. I watch it hollow out.", 'Una luna desértica de arena roja que intercambia materia con su gemela. La veo vaciarse despacio.') },
  { alias: 'Ash Twin',      source: 'Outer Wilds',            rarity: 'common',    lore: t("Coperto di sabbia che scorre come un clessidra cosmica. Sotto ci dev'essere qualcosa di sepolto.", "Covered in sand flowing like a cosmic hourglass. Something must be buried beneath.", 'Cubierto de arena que fluye como un reloj de arena cósmico. Algo debe estar enterrado debajo.') },
